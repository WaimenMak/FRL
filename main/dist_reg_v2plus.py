# -*- coding: utf-8 -*-
# @Time    : 2022/3/21 13:31
# @Author  : Weiming Mai
# @FileName: dist_reg_v2plus.py
# @Software: PyCharm
...
class Arguments():
    def __init__(self):
        ...
        # self.env_seed = None
        self.filename = f"v2plus_distilstd{self.std}_noicy{self.noisy_input}_{self.playing_step}_{self.env_name}{self.env_seed}_N{self.N}_M{self.M}_L{self.L}_criticdual{self.critic_dual}{self.critic_partial}_epc{self.critic_epc}_actordual{self.actor_dual}{self.actor_partial}_reweight{self.reweight}{self.reweight_tau}_distepoch{self.epochs}_lrdecay{self.schedul}"  #filename:env_seed, model_name:env_name
