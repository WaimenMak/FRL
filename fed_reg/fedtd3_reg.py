...
class Arguments():
    def __init__(self):
        ...
        # self.env_seed = None
        self.filename = f"niidevalfed3e4_{self.env_name}{self.env_seed}_N{self.N}_M{self.M}_L{self.L}_beta{self.beta}_mu{self.mu}"  #filename:env_seed, model_name:env_name
