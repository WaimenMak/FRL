...
class Arguments():
    def __init__(self):
        ...
        # self.env_seed = None
        self.filename = f"centerniid_{self.env_name}{self.env_seed}_M{self.M}"  #filename:env_seed, model_name:env_name
...
def GenerateAgent(args):
    ...
    for i in range(args.client_num):
        # agent, local_env = agent_env_config(args, seed=3)
